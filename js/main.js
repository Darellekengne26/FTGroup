  ...
  // Fonction pour faire défiler le texte
    function scrollText() {
        ...
        if (containerWidth < textWidth) {
            ...
            containerWidth = scrollingElement.offsetWidth;
    ...
    // Démarrer le défilement lorsque la fenêtre est chargée
